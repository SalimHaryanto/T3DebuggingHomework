...
class PageVCWithSkip: UIPageViewController {
...
extension PageVCWithSkip {
    ...
    func setup() {
        ...
        let rootNavigationController = storyBoardRef.instantiateViewController(withIdentifier: "RootNavigationController") as! UINavigationController
        
        let page1 = viewController
        let page2 = helloWorldViewController
        let page3 = rootNavigationController
...
extension PageVCWithSkip: UIPageViewControllerDataSource {
...
extension PageVCWithSkip: UIPageViewControllerDelegate {
